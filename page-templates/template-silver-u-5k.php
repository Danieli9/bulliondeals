		    ...
		    if( $my_query->have_posts() ) {
		        ...
		        while ($my_query->have_posts()) : $my_query->the_post();
		            ...
		            <nav class="pagination">
		                <button class="btn-whole"><?php previous_posts_link('Previous Page', $my_query->max_num_pages); ?></button>
		                <button class="btn-whole"><?php next_posts_link('Next Page', $my_query->max_num_pages); ?></button>
		            </nav>
		<?php } wp_reset_query(); ?>
	</div><!-- #content -->
</div><!-- #page-wrapper -->
